...
namespace eqlib {
    ...
    public: // constructors
        ...
        SparseStructure(const TIndex rows, const TIndex cols, const std::vector<TIndex>& ia, const std::vector<TIndex>& ja) : m_rows(rows), m_cols(cols), m_ia(ia), m_ja(ja)
        {
    ...
    using CsrStructure = SparseStructure<>;
