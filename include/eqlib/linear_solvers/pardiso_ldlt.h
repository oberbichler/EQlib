...
struct PardisoLDLT : public LinearSolver {
...
private: // static methods
    static MKL_INT pardiso(_MKL_DSS_HANDLE_t pt, MKL_INT maxfct, MKL_INT mnum, MKL_INT mtype, MKL_INT phase, MKL_INT n, const double* a, const MKL_INT* ia, const MKL_INT* ja, MKL_INT* perm, MKL_INT nrhs, MKL_INT* iparm, MKL_INT msglvl, void* b, void* x)
    {
        MKL_INT error = 0;
